	...
	return (
		<div className="privacy-page">
			<div className="banner-privacy">
				<h1>Lambda Inc. Privacy Policy</h1>
			...
			<div className="privacy-container">
				...
				<p>
					...
					Policy Page You can change your personal information: By emailing us
				</p>
				...
				<p>
					...
					from children under 13? We do not specifically market to children
				...
				<p>
					...
					<a href="mailto:support@lambdaschool.com">
						support@lambdaschool.com{' '}
					</a>
				...
				<p>
					<a href="https://lambdaschool.com">https://lambdaschool.com</a>
					<br />
